# create an s3 bucket
aws s3 mb s3://alice-code-sam-second-attempt
...
aws cloudformation package --s3-bucket alice-code-sam-second-attempt --template-file template.yaml --output-template-file gen/template-generated.yaml
